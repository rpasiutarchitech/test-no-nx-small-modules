...
import { Lib1SharedComponent1Component } from './lib1-shared-component1/lib1-shared-component1.component';
...
@NgModule({
  ...
  exports: [Lib1SharedComponent1Component]
})
export class Lib1SharedModule { }
